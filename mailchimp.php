<?php
/** MailChimp Custome Code Created By Pankaj Joshi */
class Newsletter
{
    ...
    public function subscribe(string $email,array $tags ,array $mergeFields = [], string $listName = '', array $options = [])
    {
        $list = $this->lists->findByName($listName);
    
        $options = $this->getSubscriptionOptions($email,$tags,$mergeFields, $options);
    ...
    protected function getSubscriptionOptions(string $email,array $tags ,array $mergeFields, array $options): array
    {
        $defaultOptions = [
            'email_address' => $email,
            'status' => 'subscribed',
